package com.putya.timetable

import android.content.Context
import android.util.AttributeSet
import com.putya.timetable.cell.XxisEndView
import com.putya.timetable.cell.XxisView
import com.putya.timetable.cell.ZeroPointView
import com.putya.timetable.model.ScheduleEntity
import com.putya.timetable.schedule.ScheduleView
import com.putya.timetable.tableinterface.OnScheduleClickListener
import com.putya.timetable.tableinterface.OnScheduleLongClickListener
import com.putya.timetable.tableinterface.OnTimeCellClickListener
import com.putya.timetable.utils.dpToPx
import com.putya.timetable.utils.getWindowWidth
    ...
    fun initTable(dayList: Array<String>) {
        ...
        if (super.isFullScreen) {
            timetable.setPadding(
                super.widthPaddingPx.roundToInt(),
                0,
                super.widthPaddingPx.roundToInt(),
                0
            )
        ...
        leftMenu.layoutParams =
            LayoutParams(super.leftMenuWidthPx.roundToInt(), LayoutParams.WRAP_CONTENT)
        topMenu.layoutParams =
            LayoutParams(LayoutParams.WRAP_CONTENT, super.topMenuHeightPx.roundToInt())
        ...
        com.putya.timetable.utils.removeViews(
            arrayOf(
                zeroPoint,
                topMenu,
                timeCell,
